				...
				onApprove={(data,actions) => {
					return actions.order.capture().then((details)=> {
						...
						Swal.fire({
							...
							text: `Gracias por tu pago ${name} del Reto Keto 3, en breve recibiras un correo a ${email} con la informacion solicitada y otro correo con la informacion de pago de paypal`,
