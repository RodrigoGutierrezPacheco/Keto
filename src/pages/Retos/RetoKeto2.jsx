						...
						purchase_units:[
							{
								...
								name:"Reto 1",
								description:"Reto keto 2 que te ayudara a cumplir todas tus metas del mundo"
							},
						],
						application_context: {
				...
				onApprove={(data,actions) => {
					return actions.order.capture().then((details)=> {
						...
						Swal.fire({
							...
							text: `Gracias por tu pago ${name} del Reto Keto 2, en breve recibiras un correo a ${email} con la informacion solicitada y otro correo con la informacion de pago de paypal`,
							confirmButtonColor: '#3085d6',
						})
						emailjs.send("service_n648gkj","template_d0uug9r",{
							user_name: {name},
							to:{email},
